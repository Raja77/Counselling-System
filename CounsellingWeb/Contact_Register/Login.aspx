<%@ Page Title="Log in" Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="CounsellingWeb.Login" %>
<!DOCTYPE html>
<html lang="en">

<head>
    <title>Welcome to Counselling Portal _ Log In </title>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" runat="server" id="frmLogIn">
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="text" name="email" class="form-control" id="txtLogIn" runat="server" required="">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                         <%--   <button type="button" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Sign in</button>--%>
                                            <asp:LinkButton ID="lnkLogIn"  runat="server" CssClass="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20"
                                                OnClick="lnkLogIn_Click">Sign in</asp:LinkButton>
                                        </div>
                                    </div>
                                    <hr/>
                                      <div class="row">
                                    <div class="col-md-10">
                                        <p class="text-inverse text-left"><a href="Register.aspx"><b>Create a new Account</b></a></p>
                                    </div>
                                          </div>
