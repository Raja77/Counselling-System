<%@ Page Title="View Profile" Language="C#" MasterPageFile="~/Counselling/Counselling.Master" AutoEventWireup="true" CodeBehind="ViewProfile.aspx.cs" Inherits="CounsellingWeb.ViewProfile" %>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="form-group has-warning row">
                                                            <div class="col-sm-2">
                                                                <label class="col-form-label" for="inputWarning1">
                                                                    Input with
                                                                                    warning</label>
                                                            </div>
                                                            <div class="col-sm-10">
                                                                ...
                                                                <div class="col-form-label">
                                                                    Shucks, check the formatting of that
                                                                                        and try again.
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group has-danger row">
                                                            <div class="col-sm-2">
                                                                <label class="col-form-label" for="inputDanger1">
                                                                    Input with
                                                                                        danger</label>
                                                            </div>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control form-control-danger"
                                                                    id="inputDanger1">
                                                                <div class="col-form-label">
                                                                    Sorry, that username's taken. Try
                                                                                            another?
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label txt"><span class="RequiredField">* </span>User Name</label>
                                    <div class="col-sm-5">
                                        <asp:TextBox ID="txtUserName" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvUserName" runat="server" Placeholder="User Name" CssClass="lbl" ErrorMessage="<b>User Name  is required</b>"
                                            ControlToValidate="txtUserName" Display="Dynamic" ValidationGroup="SubmitUserInfo"></asp:RequiredFieldValidator>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label txt"><span class="RequiredField"> </span>User Email</label>
                                    <div class="col-sm-5">
                                        <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvEmail" runat="server" CssClass="lbl" ErrorMessage="<b>User Email is required</b>"
                                            ControlToValidate="txtEmail" Display="Dynamic" ValidationGroup="SubmitUserInfo"></asp:RequiredFieldValidator>
                                    </div>
                                </div>

                                     <div class="form-group row">
                                    <label class="col-sm-2 col-form-label txt"><span class="RequiredField"> </span>College</label>
                                    <div class="col-sm-5">
                                        <asp:TextBox ID="txtCollege" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label txt"><span class="RequiredField">* </span>Phone No.</label>
                                    <div class="col-sm-5">
                                        <asp:TextBox ID="txtPhone" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvPhone" runat="server" CssClass="lbl" ErrorMessage="<b>Phone No. is required</b>"
                                            ControlToValidate="txtPhone" Display="Dynamic" ValidationGroup="SubmitUserInfo"></asp:RequiredFieldValidator>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label txt"><span class="RequiredField">* </span>Password</label>
                                    <div class="col-sm-5">
