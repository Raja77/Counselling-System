<%@ Page Title="Student General Elective Selection" Language="C#" MasterPageFile="~/Counselling/Counselling.Master" AutoEventWireup="true" CodeBehind="DashBoard.aspx.cs" Inherits="CounsellingWeb.DashBoard" %>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 id="userEvents" runat="server">User Events</h5>
                                </div>
                                <div class="card-block table-border-style">
                                    <div class="table-responsive">


                                        <asp:GridView ID="grdUserEvents" runat="server" CellPadding="0" CellSpacing="0" CssClass="table table-hover"
                                            DataKeyNames="UserID" GridLines="None" AutoGenerateColumns="false">
                                            <HeaderStyle />
                                            <EmptyDataTemplate>
                                                <label class="lbl">No User event found in our system !</label>
                                            </EmptyDataTemplate>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Description of Event">
                                                    <ItemTemplate>
                                                        <asp:Label runat="server" Text='<%#MakeShort(Convert.ToString(Eval("EventDescription")))%>' ToolTip='<%#Eval("EventDescription")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            ...
                                            <%#  Eval("Image") %>' style="max-height:70px; max-width:100px;"
                                                           />
                                                        <%--     <br />      
                                            <asp:FileUpload ID="fu1" runat="server" />--%>
                                                ...
                                                <asp:TemplateField HeaderText="ACTION" HeaderStyle-Width="150px" Visible="false">
                                                    <ItemTemplate>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Jun, 26</td>
                                                    <td class="text-right">
                                                        <label class="label label-danger">Low</label></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <div class="chk-option">
                                                    ...
                                                    <td>March, 31</td>
                                                    <td class="text-right">
                                                        <label class="label label-primary">high</label></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <div class="chk-option">
                                                    ...
                                                    <td>Aug, 02</td>
                                                    <td class="text-right">
                                                        <label class="label label-success">medium</label></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <div class="chk-option">
