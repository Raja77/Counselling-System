...
//"https://themeforest.net/item/mega-able-bootstrap-4-and-angular-5-admin-dashboard-template/20790784?ref=phoenixcoded"
$('body').append('' +
    '<div class="fixed-button">' +
        '<a href="#" target="_blank" class="btn btn-md btn-primary">' +
            '<i class="fa fa-shopping-cart" aria-hidden="true"></i> THEME CHECK' +
        '</a> ' +
    '</div>' +
'');
var $window = $(window);
