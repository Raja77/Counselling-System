<%@ Page Title="Student General Elective Selection" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="GESelection.aspx.cs" Inherits="CounsellingWeb.GESelection" EnableViewState="true" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <asp:GridView ID="grdStudentsDetail" CellPadding="0" CellSpacing="0" CssClass="table"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Marks obtained in 12th" ItemStyle-Width="20%">
                    <ItemTemplate>
    ...
    <h2>
           <div class="mb-4 row">
            <label for="lblAllocatedPref" class="col-sm-3 txt">Allocated Preference</label>
            <div class="col-sm-8">
          <asp:Label ID="lblAllocatedPref" runat="server"></asp:Label>
            </div>
        </div></h2>
    ...
    <div id="dvPref" runat="server" visible="false">
        ...
        <hr />
        <div class="mb-4 row">
            <label for="drppref1" class="col-sm-3 txt"><span class="RequiredField">* </span>GE 1st Preference</label>
            <div class="col-sm-8">
                <asp:DropDownList ID="drppref1" runat="server" CssClass="form-control drp" AutoPostBack="true" OnSelectedIndexChanged="drppref1_SelectedIndexChanged">
                </asp:DropDownList>
        ...
        <br />
        <div class="mb-4 row">
            <label for="drppref2" class="col-sm-3 txt"><span class="RequiredField">* </span>GE 2nd Preference</label>
            <div class="col-sm-5">
                <asp:DropDownList ID="drppref2" runat="server" CssClass="form-control drp" AutoPostBack="true" OnSelectedIndexChanged="drppref2_SelectedIndexChanged" Enabled="false">
                </asp:DropDownList>
        ...
        <div class="mb-4 row">
            <label for="drppref3" class="col-sm-3 txt"><span class="RequiredField">* </span>GE 3rd Preference</label>
            <div class="col-sm-5">
                <asp:DropDownList ID="drppref3" runat="server" CssClass="form-control drp" AutoPostBack="true" OnSelectedIndexChanged="drppref3_SelectedIndexChanged" Enabled="false">
                </asp:DropDownList>
        ...
        <br />
        <div class="mb-4 row">
            <label for="drppref4" class="col-sm-3 txt"><span class="RequiredField">* </span>GE 4th Preference</label>
            <div class="col-sm-5">
                <asp:DropDownList ID="drppref4" runat="server" CssClass="form-control drp" AutoPostBack="true" OnSelectedIndexChanged="drppref4_SelectedIndexChanged" Enabled="false">
    ...
    <div>
            <div class="col-sm-3">
                <asp:Button ID="btnViewAllocation" runat="server" CssClass="btn" Text="View Allocation" CausesValidation="false" OnClick="btnViewAllocation_Click" />
            </div>
    </div>

    <asp:Table ID="AllocationSummary" runat="server" CssClass="table">
        <asp:TableHeaderRow>
       ...
       <asp:GridView ID="GridView1" CellPadding="0" CellSpacing="0" CssClass="table"
